...
export class RideRepositoryDatabase implements RideRepository {
    ...
    async update(ride: Ride): Promise<void> {
        await this.connection.query(`UPDATE cccat15.ride SET driver_id=$1, status=$2 WHERE ride_id=$3::uuid`, [ride.getDriverId(), ride.getStatus(), ride.rideId]).catch(e => { console.log(e) });
    }
